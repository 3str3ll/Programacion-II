...
public class TestVectorial {
    public static void main(String[] args) {
        ...
        AlgebraVectorial v3 = new AlgebraVectorial(0, 0, 1); // Pract2.Vector perpendicular a v4
        AlgebraVectorial v4 = new AlgebraVectorial(1, 0, 0); // Pract2.Vector perpendicular a v3
        AlgebraVectorial v5 = new AlgebraVectorial(2, 4, 6); // v5 = 2*v1
